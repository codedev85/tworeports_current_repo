...
<div class="top__bar">
        ...
        <div class="top__bar--main">
            ...
            <div class="top__bar-hero">
                    ...
                    <div><span>UPDATE ABOUT US</span></div>
            ...
            <div class="form__header--list">
                ...
                <div class="form__header--list1">
                    ...
                    {{-- <P class="homepage__para">
                               <img src="../left-arrow.svg" alt="" class="back__arrow"><span class=""><a href="{{url('/create-vision/')}}">Create Vision</a></span>
                            -  <img src="../left-arrow.svg" alt="" class="back__arrow"><span class=""><a href="{{url('/mission-create/')}}">Create Mission</a></span>
                            -  <img src="../left-arrow.svg" alt="" class="back__arrow"><span class=""><a href="{{url('/create-value/')}}">Create Values</a></span>
                    </P> --}}
                </div>
...
<form action="{{url('/about-update/'.$find_about_us->id)}}" method="post">
    @csrf
                <div class="center__container" id="czContainer">
                    ...
                    <div class="center__container--wrapper control-group after-add-more"">
                        ...
                        <textarea name="about_desc" class="summernote" placeholder="Main Title">
                            <?php echo html_entity_decode(strip_tags($find_about_us->title)); ?>
