        ...
        <div class="center__Container">
            <div class="form__header--list">
                ...
                <div class="form__header--list1">
                    ...
                    <P class="aboutus__hero--container">
                        <button id="" class=""><span class="">Add new item</span></button>
                    </P>
                </div>
            ...
            <div class="form__container">
                ...
                <div class="table__container">
                    ...
                    @foreach($find_about_us as $about)

                       <tr class="table__row">
                           <td class="table__data"><img src="../resource/images/Ellipse (5).svg"></td>
                           <td class="table__sec--col">April 16th, 2019.</td>
                           <td class="table__third--col">{{$about->hero_bg_text}}</td>
                       <td class="table__data"><a href="{{url('/aboutus/edit/'.$about->id)}}">EDIT </a><span>|</span> DELETE</td>
                       </tr>
                    @endforeach
                    </table>
