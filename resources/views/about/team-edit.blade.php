    ...
    @csrf
                <div class="center__container">
                    ...
                    <div class="center__container--wrapper">
                        <input type="text" name="name" placeholder="Name" value="{{$team->name}}">
                        <input type="text" name="main_title" placeholder="Title" value="{{$team->title}}">
                        <textarea name="desc" placeholder="Description">
                                {{$team->description}}
                            </textarea>
                        <input type="text" name="fun_fact" placeholder="Fun Facts" value="{{$team->fun_fact}}">
                        <textarea  name="fun_fact_desc" placeholder="Fun Fact Description" >{{$team->fun_fact_desc}}</textarea>
