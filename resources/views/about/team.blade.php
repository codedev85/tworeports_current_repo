...
{{--
      ...
      <form action="{{url('/create-team-post/')}}" method="post" enctype="multipart/form-data">
                    @csrf
                <div class="center__container">
                    <div class="center__container--wrapper">
                        <input type="text" name="name" placeholder="Name">
                        <input type="text" name="main_title" placeholder="Title">
                        <textarea name="desc" class="summernote" placeholder="Description"></textarea>
                        <input type="text" name="fun_fact" placeholder="Fun Facts">
                        <textarea name="fun_fact_desc" class="summernote" placeholder="Fun fact Description"></textarea>
