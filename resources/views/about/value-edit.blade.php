...
<div class="top__bar">
        ...
        <div class="top__bar--main">
            ...
            <div class="top__bar-hero">
                    ...
                    <div><span>UPDATE VALUE</span></div>
...
<form action="{{url('/value-update/'.$find_value->id)}}" method="post" enctype="multipart/form-data">
    @csrf
                <div class="center__container">

                    <div class="center__container--wrapper">
                        <input name="main_title" placeholder="title" value="{{$find_value->title}}">
                         <input type="file" name="value_img" placeholder="title">
                        <textarea name="value_desc" placeholder="Description">
