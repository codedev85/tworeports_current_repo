...
<div class="top__bar">
        ...
        <div class="top__bar--main">
            ...
            <div class="top__bar-hero">
                    ...
                    <div><span>CREATE VISION</span></div>
...
<form action="{{url('/create-vision-post/')}}" method="post" enctype="multipart/form-data">
    @csrf
                <div class="center__container">
                    ...
                    <div class="center__container--wrapper">
                        ...
                        <textarea name="vision_desc" placeholder="Description"></textarea>
