...
<head>
    ...
    <title>TWOREPORT Admin Mail</title>
</head>
    ...
    <section class="">
        <div class="mainContainer">
            <div class="left__bar">
                ...
                </div><button class="red__homepage--btn" id="form-submit-button"><span>Send Mail</span></button> 
...
<div class="center__Container">
        <div class="form__header--list">
            <div class="form__header--list1">
                ...
                $path = [];
                $emails = $email_array;
               $new_arr = array_push($path, $emails);
