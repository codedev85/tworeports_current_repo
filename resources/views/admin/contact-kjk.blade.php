...
<head>
    ...
    <title>TWOREPORT Contact Kjk</title>
</head> --}}
<!DOCTYPE html>
<html lang="en">
...
<!-- wysisyg -->
   ...
   <style>
    ...
    <title>TWOREPORT Contavt KJK</title>
</head>
<body>
<div class="top__bar">

        <div class="top__bar--main-contact_kjk">

            <span><img src="../resource/imageS/tworeport__logo.svg" alt="" class="home__img"></span>

            <div class="top__bar-hero">

                    {{-- <div><span>CONTACT KJK</span></div> --}}
...
<body>
    ...
    <header class="header header__about">
        ...
        <div class="hero__img_advisory--bg">
            ...
            <div class="hero__images__slide_inner_container">
                <div class="slide__contact_kjk">
                    {{-- <h1 class="contact-kjk-header">Contact KJK</h1> --}}
                </div>
            </div>
    ...
    <section>
        ...
        <div class="row center__main--container">

            <div class="left__profile--box">

                <div class="left__img--icon">
                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3964.095900860934!2d3.3689049147182373!3d6.509544195291307!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x103b93e074460ff7%3A0x127ae19b36a7f72f!2sKJK.Africa%20(KJK)!5e0!3m2!1sen!2sng!4v1568654260195!5m2!1sen!2sng" width="600" height="450" frameborder="0" style="border:0;" allowfullscreen=""></iframe>
                    {{-- <img src="../resources/images/avatar__about.svg" alt="" class="advisory__img"> --}}
                </div>

                <div class="left__profile--sub">
                    ...
                    <!-- <p class="title__box">
                        <button class="red__bg--btn">EDIT PROFILE</button>
                    </p> -->
                </div>

                
            </div>
            <div class="right__desc--box news-paragraph">
                <h1 >Contact us</h1>
                <br>
                <h4>We would love to help with the admin panel</h4>
                <h4>Let us know your thoughts</h4>
                 <br>
                 <form action="{{ url('/send-mail-to-kjk') }}" method="post">
                    @csrf
                   <span class="p__r"><img src="../resource/images/phone.svg" height="30" width="30"/>&nbsp; 08065848484</span>  <br><br>
                   <span><img src="../resource/images/mail.svg" height="30" width="30"/>&nbsp; info@kjk.africa </span>
                   <br><br>
                 
                   <span><img src="../resource/images/domain.png" height="30" width="30"/>&nbsp; www.kjk.africa </span>
                   <br><br>
                  
                  
                     <input class="subject_input" placeholder="subject" name="subject" >
                     <br><br>
                    <textarea placeholder="funfact" name="desc"> </textarea>
                    <button class="email_btn">Send Mail</button>
                 </form>
            </div>
        </div>
    ...
    {{-- <div class="nav_menu__resp">
            <nav class="resp_menu">
                ...
                <div class="drp_container__mobile">
                        <a href="talents.html" class="drp_down__links">
                            Become a Team Player
                        </a>
                </div>
                        ...
                        <div class="check_discription_section">
                            <div class="modal__check__outer">
                                    ...
                                    <div class="modal__check_container">
                                            ...
                                            <label for="download__recieve">Receive Our NewsLetter <a href="" class="label_red">UNSCRIPTED</a></label>
                                    </div>
                                    <div class="modal__check_container">
                                    ...
                                    <div class="modal__check_container">
                                            ...
                                            <label for="download__policy">By clicking <a href="" class="label_red">submit</a>, you agree to the terms of <a href="" class="label_red">Privacy Policy</a></label>
                                    </div>
                            ...
                            <div class="modal__check__outer">
                                <h3 class="modal__check_title">
                                    ...
                                    <div class="modal__check_container">
                                        ...
                                        <label for="download__deselect"><span class="download__deselect--text">Deselect All</span></label>
                                    </div>
                                    <div class="modal__check_container">
                                            <input type="checkbox" name="" id="download__consent" class="unchecked">
                                            <label for="download__consent">I consent to TWOREPORT storing my submitted information so they can respond 
                                                    to my enquiry</label>
                                    </div>
                                    <div class="modal__check_container">
                                            <input type="checkbox" name="" id="download__recieve" class="unchecked1">
                                            <label for="download__recieve">I consent that my contact information can be added to your mailing list for any 
                                                    future correspondence 
                                            </label>
                                    </div>
                                    <div class="modal__check_container">
                                            <input type="checkbox" name="" id="download__agree" class="unchecked2">
                                            <label for="download__recieve">I agree to the <a href="" class="label_red">Terms of Use of this website </a>
                                            </label>
                                    </div>
                            ...
                            <div class="modal__check__outer">
                                ...
                                <p class="respect__text">We respect your inbox and privacy, you may unsubscribe at anytime.</p>
                            </div>
                        </div>
