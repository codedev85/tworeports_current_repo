...
<head>
    ...
    <title>TWOREPORT Advisory_board</title>
</head>
...
<body>
        ...
        <div class="row center__main--container">
            ...
            <div class="left__profile--box">
                ...
                <div class="left__profile--sub">
                    ...
                    <p class="title__box">
                        <h1>{{$find_adv->name}}</h1>
                        <span class="title__sub--sub">{{$find_adv->title}}</span>
                    </p>
                    <p class="title__box">
            ...
            <div class="right__desc--box news-paragraph">
                ...
                <?php echo html_entity_decode(Ucfirst(Purifier::clean($find_adv->adv_desc)));?>
    ...
    <section class="advisory_advisory--section">

        <div class="row">

            <h1 class="story__title advisory__advisory--title">
                Members
            </h1>

            <div class="advisory__img_container">
          @foreach($random_adv as $adv)
                <div class="advisory__img_inner">

                    <img src="../resources/images/avatar__about.svg" alt="" class="advisory__img">

                    <div class="advisory__img_details">
                        <div class="advisory__img_details_inner">
            ...
            <div class="footer__inner_container">
                <div class="footer__outer_wrapper row">
                    ...
                    <div class="footer__list_container">
                        ...
                        <a href="" class="home__btn home__btn--contact home__btn--footer home__btn--touch">
                            Get in touch
                        </a>
                    ...
                    <div class="footer__list_container">
                        ...
                        <a href="" class="home__btn home__btn--contact home__btn--footer">
                            Subscribe
                        </a>
