...
<body>
  ...
  @if(Auth::guest() && $article->article_is_not_free != 0)
  ...
  @elseif(!Auth::guest())
            @if($tranx != NULL)
                                ...
                                @elseif($tranx->customer_email == Auth::user()->email && $tranx->status == 'paid')

                                        <a href="{{ url('casestudy-pdf/'.$article->id)}}" class="download_btn js_modal_trigger__btn home__btn">DOWNLOAD</a>
            ...
            @elseif(Auth::check() && $article->article_is_not_free != 0)
            ...
            @elseif($article->article_is_not_free == 0)
    ...
    @elseif(Auth::guest() && $article->article_is_not_free == 0)
