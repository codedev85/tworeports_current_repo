                            ...
                            <div class="four__section--wrapper">
                                ...
                                <div class="right__section">
                                    <div class="three__section--wrapper">
                                        <input class="case_study_input" name="tags" placeholder="tagged" value="{{$find_article->tag}}">
                                        <input class="case_study_input" name="links" placeholder="links" value="{{$find_article->link}}">
                                        <input class="case_study_input" id="form1" name="price" placeholder="price" value="{{$find_article->price}}" required>
                                        <!-- <div class="container custom__edit--img-inner1">
                                            <div class="white__small--btn-wrapper">
                                            <button class="white__small--btn">1</button>
                                            <button class="white__small--btn">2</button>
