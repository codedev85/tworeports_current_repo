        ...
        <div class="center__Container">
            <div class="form__header--list">
                ...
                <div class="form__header--list1">
                    ...
                    <a href="{{url('/create/case/study/')}}">

                    <P class="aboutus__hero--container">
                        <button id="" class=""><span class="">Create New Case Study</span></button>
                    </P>
                </a>
                &nbsp;
                <a href="{{url('/case/category/')}}">
                    ...
                    <P class="aboutus__hero--container">
                        <button id="" class=""><span class="">Case Study Category</span></button>
                    </P>
                </a>
                </div>
            ...
            <div class="form__container">
                ...
                <div class="table__container">
                    ...
                    <table class="table__container--main">
                       ...
                       <td class="table__third--col">dggdgd</td>
                       <td class="table__data"><a href="">EDIT</a><span>|</span> DELETE</td>
                       </tr>
