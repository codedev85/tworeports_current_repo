        ...
        <div class="center__Container">
            <div class="form__header--list">
                ...
                <div class="form__header--list1">
                    ...
                    <button id="" class=""><span class=""><a href="{{url('history-create')}}"> Add New Story</a></span></button>
                    </P>
                </div>
                ...
                <div class="table__container">
                    ...
                    @foreach($history as $hist)
                       ...
                       <tr class="table__row">
                           ...
                           <td class="table__third--col">{{$hist->year}}</td>
                       <td class="table__data"><a href="{{url('/new-team-edit/'.$hist->id)}}">EDIT </a><span>|</span> DELETE</td>
                       </tr>
                    @endforeach
                    </table>
