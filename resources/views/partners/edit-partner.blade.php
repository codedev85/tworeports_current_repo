...
<div class="top__bar">
        ...
        <div class="top__bar--main">
            ...
            <div class="top__bar-hero">
                    ...
                    <div><span>EDIT PARTNER'S PAGE</span></div>
...
{{--
        ...
        <div class="center__Container">
            ...
            <div class="main__container">
              <form action="{{url('/post-partner-update/'.$find_partner->id)}}" method="post" enctype="multipart/form-data">
                  @csrf
                <div class="center__container" id="czContainer">
                    <div class="center__container--wrapper control-group after-add-more"">
                        <input name="partner_name" placeholder="Partner" value="{{$find_partner->name}}">
