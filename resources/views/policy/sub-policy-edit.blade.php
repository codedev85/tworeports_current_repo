...
<div class="top__bar">
        <div class="top__bar--main">
            ...
            <div class="top__bar-hero">
                    ...
                    <div><span>EDIT SUB POLICY</span></div>
...
<!-- anothe ends here -->
        <div class="center__Container">
            ...
            <div class="main__container">
              <form action="{{url('/policy-create-post/')}}" method="post" enctype="multipart/form-data">
                  @csrf
                <div class="center__container" id="czContainer">
                    <div class="center__container--wrapper control-group after-add-more">
                        <input name="sub_policy_title" placeholder="Policy" value="{{$edit_sub_policy->policy_title}}">
                         <textarea name="sub_policy_desc" class="summernote" placeholder="Policy Description">
                            {{$edit_sub_policy->policy_desc}}
                       </textarea>
                     <button class="red__homepage--btn"><span>Update</span></button>
                    </div>
                </div>
            </form>
            </div>
