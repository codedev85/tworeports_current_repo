            ...
            <div class="ranking__filter_container">
                ...
                <div class="ranking__filter_content">
                    ...
                    <div class="custom-select">
                        {{-- <select>
                            @foreach($rankCategory as $rankCat)
                            <a href="{{ '/rank-category/'.$tv_ranks->id }}">
                                <option value="{{ $rankCat->id }}">
                        ...
                        <div class="dropdown">
                            <button onclick="myFunction()" class="dropbtn custom-select">SELECT TOP 15 LIST</button>
                            <div id="myDropdown" class="dropdown-content">
                                @foreach($ranks_cat as $cat)
                              <a href="{{url('/rank-catgory/'.$cat->id)  }}">{{ $cat->name }}</a>
                              @endforeach
                            </div>
                          </div>
                    </div>
    ...
    //                    ?>
                        ...
                        @foreach(json_decode($tv_cat->rank_name)[0] as $key => $va)
                            ...
                            <tr>
                                 ...
                                 <td>{{ json_decode($tv_cat->rank)[0][$key]}}</td> 
            ...
            <div class="footer__inner_container">
                <div class="footer__outer_wrapper row">
                    ...
                    <div class="footer__list_container">
                        <a href="{{ url('/about-us') }}" class="footer__link footer__link--title">
                            About us
                        </a>
