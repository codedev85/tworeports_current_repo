...
<div class="top__bar">
        ...
        <div class="top__bar--main">
            ...
            <div class="top__bar-hero">
                    ...
                    <div><span>SERVICES CREATE</span></div>
    ...
    <div class="mainContainer">
        ...
        <div class="left__bar">
            ...
            <div class="left__homepage--container">
                ...
                <div class="left__menu--item">
                    <img src="../Vector (1).svg" alt="" class="left__menu--icon">
                    <a href="{{url('/hero-bg/')}}">Set Background Image</a>
                </div>
                <div class="left__menu--item">
...
<form action="{{url('/service-create-post/')}}" method="post" enctype="multipart/form-data">
    @csrf
    {{-- @if($service->main_title == null) --}}
                <div class="center__container">
                    ...
                    <div class="center__container--wrapper">
                        ...
                        <input name="sport_title" placeholder="Services">
                        <textarea name="sport_desc" placeholder="Services description..."></textarea>
