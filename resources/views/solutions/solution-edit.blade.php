...
<div class="top__bar">
        ...
        <div class="top__bar--main">
            ...
            <div class="top__bar-hero">
                    ...
                    <div><span>SOLUTIONS UPDATE PAGE</span></div>
...
<form action="{{url('/solution-update/'.$find_solution->id)}}" method="post" enctype="multipart/form-data">
    @csrf
                <div class="center__container">

                    <div class="center__container--wrapper">
                        {{-- <input name="main_title" placeholder="title" value="{{$find_solution->main_title}}">
                        <textarea name="main_desc" placeholder="subtitle">{{$find_solution->main_description}}</textarea>
                        <input type="file" name="hero_image" placeholder="Hero Image"> --}}
                        <input name="sub_title" placeholder="solution title" value="{{$find_solution->sub_title}}">
                        <textarea name="sub_desc" placeholder="description...">{{$find_solution->sub_description}}</textarea>
                        <input type="file" name="solution_image" placeholder="solution Image">
