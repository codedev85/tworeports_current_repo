...
<div class="top__bar">
        <div class="top__bar--main">
            ...
            <div class="top__bar-hero">
                    <div><span>TALENTS BACKGROUND IMAGE</span></div>
            </div>
        </div>
</div>
<section class="">
...
<form action="{{url('/talent-create-hero-post/')}}" method="post" enctype="multipart/form-data">
    @csrf
                <div class="center__container">
                    <div class="center__container--wrapper">
                        {{-- <textarea name="main_desc" placeholder="subtitle"></textarea> --}}
                        <input  name="talents_txt_1" placeholder="Talents Hero Background text 1">
                        <input  name="talents_txt_2" placeholder="Talents Hero Background text 2">
