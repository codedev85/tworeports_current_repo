...
<body>
    ...
    <section class="">
        ...
        <div class="center__Container">
            ...
            <form id="form-submit" method="POST" enctype="multipart/form-data" action="{{url('new/team/member/post')}}">
                @csrf
            <div class="main__container">
                <div class="center__container">
                    ...
                    <div class="center__container--wrapper center__container--sub-wrapper add__extra--padding">
                        ...
                        <input placeholder="Fun Fact" name="fun_fact" >
                        <textarea placeholder="funfact" name="fun_fact_desc"> </textarea>
